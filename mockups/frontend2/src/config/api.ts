// API Configuration for frontend2
...
const PRODUCTION_URLS = {
  ...
  // Admin dashboard URL
  ADMIN_URL: 'https://clinic-portal-rifygkov1-flora-3a1bc29e.vercel.app/', // Update this with your actual admin deployment URL
};
...
export const API_ENDPOINTS = {
  ...
  // WebSocket endpoints
  VOICE_WS: `${API_CONFIG.WS_ENDPOINT}/voice_ws`,
  
  // Admin endpoints
  ADMIN_VIEW_FORM: `${API_CONFIG.ADMIN_URL}/view-filled-form`,
};
